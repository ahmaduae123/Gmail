...
$query = "SELECT e.*, u.name AS sender_name FROM emails e JOIN users u ON e.sender_id = u.id WHERE e.recipient_id = ? AND e.status = 'inbox'";
$params = [$user_id];
if ($search) {
...
<body>
    ...
    <div class="container">
        <div class="sidebar">
            ...
            <a href="#" onclick="window.location.href='dashboard.php'" class="active">Inbox</a>
        ...
        <div class="main">
            <div class="search-bar">
                <input type="text" id="search" value="<?php echo htmlspecialchars($search); ?>" placeholder="Search emails">
    ...
    <script>
        function searchEmails() {
            ...
            window.location.href = `dashboard.php?search=${encodeURIComponent(search)}&filter=${filter}`;
        }
