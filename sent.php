...
$query = "SELECT e.*, u.name AS recipient_name FROM emails e JOIN users u ON e.recipient_id = u.id WHERE e.sender_id = ? AND e.status = 'sent'";
$params = [$user_id];
if ($search) {
...
<body>
    ...
    <div class="container">
        <div class="sidebar">
            ...
            <a href="#" onclick="window.location.href='sent.php'" class="active">Sent</a>
            <a href="#" onclick="window.location.href='drafts.php'">Drafts</a>
            <a href="#" onclick="window.location.href='trash.php'">Trash</a>
        </div>
        <div class="main">
            <div class="search-bar">
                <input type="text" id="search" value="<?php echo htmlspecialchars($search); ?>" placeholder="Search sent emails">
                ...
                <?php foreach ($emails as $email): ?>
                    <div class="email-item">
                        ...
                        <a href="#" onclick="window.location.href='view_email.php?id=<?php echo $email['id']; ?>'">
                            <span class="email-recipient"><?php echo htmlspecialchars($email['recipient_name']); ?></span>
                        ...
                        <button onclick="moveToTrash(<?php echo $email['id']; ?>)">Delete</button>
                    </div>
                <?php endforeach; ?>
            </div>
        </div>
    ...
    <script>
        function searchEmails() {
            ...
            window.location.href = `sent.php?search=${encodeURIComponent(search)}&filter=${filter}`;
        }
