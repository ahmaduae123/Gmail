...
$query = "SELECT e.*, u.name AS recipient_name FROM emails e JOIN users u ON e.recipient_id = u.id WHERE e.sender_id = ? AND e.status = 'draft'";
$params = [$user_id];
if ($search) {
...
<head>
    ...
    <title>Gmail Clone - Drafts</title>
    <style>
        body {
            margin: 0;
...
<body>
    ...
    <div class="container">
        <div class="sidebar">
            ...
            <a href="#" onclick="window.location.href='drafts.php'" class="active">Drafts</a>
            <a href="#" onclick="window.location.href='trash.php'">Trash</a>
        </div>
        <div class="main">
            <div class="search-bar">
                <input type="text" id="search" value="<?php echo htmlspecialchars($search); ?>" placeholder="Search drafts">
    ...
    <script>
        function searchEmails() {
            ...
            window.location.href = `drafts.php?search=${encodeURIComponent(search)}&filter=${filter}`;
        }
